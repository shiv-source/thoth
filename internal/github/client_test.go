...
func TestFetchReposSuccess(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`[{"full_name":"octo/wiki","clone_url":"https://github.com/octo/wiki.git","private":true,"description":"The wiki"},{"full_name":"octo/other","clone_url":"https://github.com/octo/other.git","private":false,"description":null}]`))
	}))
	t.Cleanup(ts.Close)
	...
	if len(repos) != 2 || repos[0].FullName != "octo/wiki" || repos[0].CloneURL != "https://github.com/octo/wiki.git" || !repos[0].Private || repos[1].Private || repos[0].Description != "The wiki" || repos[1].Description != "" {
