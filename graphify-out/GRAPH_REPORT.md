...
## Corpus Check
- 261 files · ~136,972 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1955 nodes · 4618 edges · 122 communities (90 shown, 32 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 636 edges (avg confidence: 0.81)
...
### Community 1 - "Deps"
Cohesion: 0.06
Nodes (58): claudeState, Deps, githubIdentity, healthResponse, modelGroup, modelInput, settingsDTO, wikiState (+50 more)
...
### Community 5 - "Run"
Cohesion: 0.10
Nodes (54): doctorRunner, net.Listener, failed(), fileExists(), newDoctorCmd(), resolveThothDir(), runDoctor(), checkAPI() (+46 more)

### Community 6 - "runServe"
Cohesion: 0.17
Nodes (21): rootHolder, log/slog.Logger, sync.RWMutex, defaultWikiPath(), devCommit(), ensureWiki(), echo.Echo, newRootHolder() (+13 more)

### Community 7 - "newRootCmd"
Cohesion: 0.13
...
### Community 12 - "ParseNote"
Cohesion: 0.07
Nodes (37): checkMalformed(), countNotes(), TestCheckMalformed(), Index, ParseNote(), TestParseNote(), TestParseNoteClosedAtEOF(), TestParseNoteRejectsBadYAML() (+29 more)
...
### Community 23 - "SearchPanel.tsx"
Cohesion: 0.15
Nodes (12): SearchView, SearchPanel(), mocks, loadHistory(), persistSearchHistory(), SEARCH_HISTORY_KEY, SEARCH_HISTORY_MAX, searchHistorySlice (+4 more)

### Community 24 - "Scaffold"
Cohesion: 0.10
Nodes (30): Init(), TestInitCreatesRepository(), TestInitErrorsWithoutGit(), folderMap(), Folders(), noteType(), NoteTypes(), NoteTypesFor() (+22 more)
...
Cohesion: 0.22
Nodes (18): prewarmStore, prewarmPool(), cliSpawnCount(), TestDefaultWikiPath(), TestDevCommit(), TestEnsureWikiRecreatesReservedAttachments(), TestPrewarmPoolEmptyDBLeavesPoolEmpty(), TestPrewarmPoolExistingConversation() (+10 more)
...
Cohesion: 0.28
Nodes (12): context.Context, github.com/fsnotify/fsnotify.Op, github.com/go-warehouse/events.Bus, fileWatcher, watchConfig, WatchOption, watchWiki(), opName() (+4 more)
...
Cohesion: 0.14
Nodes (21): react, AppHeader(), ChatPanel(), createSocket(), Composer(), NotificationPanel(), NOTIFICATION_ICONS, NOTIFICATION_PALETTE (+13 more)
...
### Community 81 - "Open"
Cohesion: 0.08
Nodes (44): Repo, database/sql.DB, executeDoctor(), healthyEnv(), serveThothOnFixedPort(), TestDoctorDetectsBusyPort(), TestDoctorDetectsMissingClaude(), TestDoctorDetectsMissingIndexTables() (+36 more)

### Community 82 - "renderWithStore"
Cohesion: 0.04
Nodes (47): mocks, renderPanel(), mocks, renderBlock(), renderCopy(), conversations, mocks, renderDashboard() (+39 more)
...
### Community 97 - "openTestRepos"
Cohesion: 0.23
Nodes (11): Option, ModelOptions(), TestModelOptionsParse(), TestModelOptionsSplitShape(), ensureModels(), openTestRepos(), TestEnsureModelsKeepsUserRows(), TestEnsureModelsReseedsEmptyTable() (+3 more)
...
Cohesion: 0.15
Nodes (20): toolLabel(), useChat(), chatIdFromPath(), ConversationRouteOptions, getConversation, renderRoute(), useConversationRoute(), ChatMessage (+12 more)
...
Cohesion: 0.12
Nodes (18): api, http, Message, Note, SearchResult, mocks, TreeNodeSchema, TreeNodeShape (+10 more)

### Community 116 - "FakeClient"
Cohesion: 0.40
...
## Knowledge Gaps
- **461 isolated node(s):** `ALLOWED_KINDS`, `config`, `@playwright/mcp`, `@ant-design/cli`, `searchLocal` (+456 more)
...
- **Why does `Deps` connect `Deps` to `context.Context`, `New`, `testDeps`, `NewPersistent`, `runServe`, `Index`, `ParseNote`, `Hub`, `Repo`, `PersistentClient`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `testDeps()` connect `testDeps` to `New`, `Deps`, `testing.T`, `New`, `Run`, `ParseNote`, `Open`, `putSettingsReq`, `newLoggingServer`, `TestGitSetupReportsSanitizedFailure`, `Open`, `api/models_test.go`?**
