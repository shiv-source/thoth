...
## Corpus Check
- 334 files · ~193,637 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2828 nodes · 7181 edges · 160 communities (127 shown, 33 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1035 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0d54f728`
...
Cohesion: 0.11
Nodes (39): TreeNode, NotesView, NotesView(), toTreeData(), WikiDataNode, WikiTree(), toolLabel(), useChat() (+31 more)

### Community 2 - "file.go"
Cohesion: 0.10
Nodes (10): IntArg(), IntArgDefault(), StringSliceArg(), WalkFiles(), walkFilesBounded(), TestSliceAndIntArgs(), List, ListRecent (+2 more)
...
Cohesion: 0.09
Nodes (32): noteTypeFor(), TestNoteTypeFor(), folderMap(), NoteType(), noteType(), NoteTypes(), NoteTypesFor(), EnsureGitRepo() (+24 more)
...
Cohesion: 0.11
Nodes (22): Feature, features, react, DashboardView, ActivityChart(), ChatActivityChart(), mockActivity, mockChatActivity (+14 more)
...
Cohesion: 0.08
Nodes (16): NewAppendFile(), NewDeleteFile(), NewEditFile(), NewRenameFile(), TestRegistryDuplicateErrors(), TestRegistryEmptyList(), TestRegistryGetUnknown(), TestRegistryRegisterGetList() (+8 more)
...
Cohesion: 0.10
Nodes (27): App(), emptyGitHub, mocks, notConfigured, settings, AppSider(), HealthFooter(), ITEMS (+19 more)
...
Cohesion: 0.17
Nodes (23): Client, Option, github.com/shiv-source/thoth/agent.Provider, log/slog.Logger, time.Duration, anthropicClient(), options, openaiClient() (+15 more)
...
Cohesion: 0.16
Nodes (28): StopDelta(), TextDelta(), ToolInputDelta(), alwaysToolProvider, TestLoopHistoryErrorFailsTurn(), TestLoopHistoryErrorWithCancelledCtx(), TestLoopProviderStreamError(), TestLoopProviderStreamErrorWithCancelledCtx() (+20 more)
...
Cohesion: 0.09
Nodes (9): UsageLine(), freshSocket(), ChatState, FakeWS, ChatSocket, ServerMessage, TokenUsage, WikiChange (+1 more)
...
Cohesion: 0.07
Nodes (31): mocks, renderPanel(), mocks, renderBlock(), ChartStub, conversations, mocks, renderDashboard() (+23 more)

### Community 84 - "client.ts"
Cohesion: 0.08
Nodes (26): api, Health, http, Message, Note, ProviderConfig, mocks, TokenUsage (+18 more)
...
Cohesion: 0.13
Nodes (10): CleanRel(), StringArg(), StringArgDefault(), TruncationMarker(), TestStringArg(), ctxAwareFake, hangClient, scriptedHangClient (+2 more)

### Community 87 - "doctor/doctor.go"
Cohesion: 0.10
Nodes (39): doctorRunner, Options, providerProbe, TestResolveThothDirEmptyUsesHome(), failed(), fileExists(), newDoctorCmd(), resolveThothDir() (+31 more)
...
Cohesion: 0.29
Nodes (6): blockingProvider, cancelProvider, streamProvider, github.com/shiv-source/thoth/agent.Request, github.com/shiv-source/thoth/agent.Stream, fakeProvider
...
### Community 99 - "SettingsView.test.tsx"
Cohesion: 0.15
...
### Community 106 - "Delta"
Cohesion: 0.19
Nodes (18): Block, Delta, StopDelta(), TestDeltaConstructors(), TextDelta(), ThinkingDelta(), ToolInputDelta(), Accumulate() (+10 more)

### Community 107 - "file_test.go"
Cohesion: 0.09
Nodes (33): TestAppendFileTool(), TestDeleteFileTool(), TestEditFileTool(), TestRenameFileTool(), NewList(), NewOSFS(), NewReadFile(), NewWriteFile() (+25 more)

### Community 109 - ".Start"
Cohesion: 0.16
Nodes (14): Accumulate(), Agent, Block, Message, requestTools(), writeDelta(), writeToolEvent(), Message (+6 more)
...
### Community 114 - "SearchPanel.tsx"
Cohesion: 0.10
Nodes (24): SearchResult, SearchView, SearchPanel(), mocks, renderSearchHook(), useSearch(), loadHistory(), persistSearchHistory() (+16 more)

### Community 115 - "ParseNote"
Cohesion: 0.12
Nodes (31): walkNotes(), FormatNote(), NoteMeta, isFence(), noteDate(), noteTags(), noteTypeValue(), ParseNote() (+23 more)

### Community 116 - "Agent"
Cohesion: 0.19
Nodes (12): Agent, Options, Message, New(), ParseBlock(), ParseMessage(), fakeProvider, TestRootAPIReexports() (+4 more)

### Community 117 - "Open"
Cohesion: 0.10
Nodes (27): database/sql.DB, TestOnSettingsSavedSwitchesRootTwice(), TestOnSettingsSavedSyncError(), onSettingsSaved(), TestGitToolOptions(), TestOnSettingsSavedFailureLeavesRootUntouched(), TestOnSettingsSavedSwitchesRootAndRestartsWatcher(), Auth (+19 more)

### Community 119 - "runServe"
Cohesion: 0.07
Nodes (56): Option, github.com/spf13/cobra.Command, ModelOptions(), TestModelOptionsParse(), TestModelOptionsSplitShape(), TestDoctorRepairIndexSyncFails(), TestDoctorRepairScaffoldFails(), TestEnsureModelsStoreError() (+48 more)

### Community 120 - "openTestRepo"
Cohesion: 0.33
...
### Community 121 - "FS"
Cohesion: 0.06
Nodes (40): time.Time, NewListRecent(), NewSearchByTag(), TestWalkNotesSkipsNonNotesAndHidden(), TestWikiToolNamesAndSchemasPopulated(), TestWikiToolSchemas(), NewReadNote(), NewWriteNote() (+32 more)
...
### Community 148 - "newLoggingServer"
Cohesion: 0.53
...
Cohesion: 0.16
Nodes (12): History(), TestHistoryDropsAllTrailingUserMessages(), TestHistoryEmptyConversation(), TestHistoryMapsMessagesAndDropsTrailingUser(), TestHistorySkipsNonChatRoles(), TestHistorySoloPromptStillDrops(), TestHistoryStoreError(), SystemPrompt() (+4 more)
...
- **Why does `Deps` connect `Deps` to `testDeps`, `anthropic.go`, `Repo`, `api/health.go`, `github.go`, `Hub`, `doctorHandler`, `putSettings`, `New`, `gitTestDeps`, `log/slog.Logger`, `context.Context`, `Service`, `listDirs`, `gitSetup`, `Index`, `api/models.go`, `Wiki`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Watch()` connect `Open` to `log/slog.Logger`, `Wiki`, `context.Context`, `runServe`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `testDeps()` connect `testDeps` to `New`, `putSettingsReq`, `Open`, `healthyThothDir`, `newLoggingServer`, `gitTestDeps`, `Open`, `New`, `testing.T`, `registry`, `api/models_test.go`, `Deps`?**
