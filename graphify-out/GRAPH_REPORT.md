...
## Corpus Check
- 281 files · ~146,962 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2173 nodes · 5146 edges · 145 communities (112 shown, 33 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 733 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bd254b56`
...
### Community 1 - "github.go"
Cohesion: 0.46
Nodes (7): githubIdentity, connectGitHub(), disconnectGitHub(), getGitHubAuth(), echo.Context, identityFromAuth(), listGitHubRepos()

### Community 2 - "New"
Cohesion: 0.14
Nodes (28): net/http.Request, net/http.ResponseWriter, TestConversationsStoreError(), TestCreateConversationRejectsEmptyTitle(), TestGetConversationFound(), TestGetConversationNotFound(), TestListDirsEndpoint(), TestListDirsEndpointErrors() (+20 more)
...
Cohesion: 0.16
Nodes (21): prewarmStore, log/slog.Logger, defaultWikiPath(), devCommit(), ensureWiki(), echo.Echo, newServeCmd(), openIndex() (+13 more)

### Community 7 - "ParseBlock"
Cohesion: 0.15
Nodes (23): decode(), Block, NewThinkingBlock(), NewToolResultBlock(), NewToolUseBlock(), ParseBlock(), ParseMessage(), TestBlockRoundTrip() (+15 more)
...
Cohesion: 0.07
Nodes (42): DoctorCheck, http, LLMModel, Message, ModelGroup, ModelInput, Note, Settings (+34 more)
...
### Community 12 - "NewTextBlock"
Cohesion: 0.21
Nodes (19): ToolInputDelta(), TestBuilderIgnoresStop(), Block, Delta, StopDelta(), TestBlockDeltas(), TestDeltaConstructors(), TextDelta() (+11 more)
...
Cohesion: 0.06
Nodes (37): poolEntry, proc, rawBlock, rawLine, rawMsg, startConfig, stderrTail, CLIClient (+29 more)

### Community 23 - "Index"
Cohesion: 0.10
Nodes (21): Repo, database/sql.DB, dbLike, Note, Result, Auth, OpenRepo(), Repo (+13 more)

### Community 24 - "scaffold_test.go"
Cohesion: 0.16
Nodes (19): folderMap(), Folders(), noteType(), NoteTypes(), NoteTypesFor(), EnsureReservedDir(), TestEnsureReservedDirCreatesWhenMissing(), TestEnsureReservedDirKeepsExistingContents() (+11 more)
...
Cohesion: 0.23
Nodes (14): Conversation, DashboardView(), ChatsList(), groupByDay(), relativeDate(), Sidebar(), navigate(), conversationsSlice (+6 more)
...
Cohesion: 0.32
Nodes (16): prewarmPool(), cliSpawnCount(), openTestRepos(), TestEnsureModelsKeepsUserRows(), TestEnsureModelsReseedsEmptyTable(), TestEnsureWikiErrorWhenAttachmentsBlocked(), TestEnsureWikiRecreatesReservedAttachments(), TestPrewarmPoolEmptyDBLeavesPoolEmpty() (+8 more)
...
Cohesion: 0.08
Nodes (34): Health, App(), NotesView, SetupScreen, AppSider(), HealthFooter(), ITEMS, healthy (+26 more)
...
Cohesion: 0.22
Nodes (15): Block, Message, NewBuilder(), NewTextBlock(), NewThinkingBlock(), NewToolResultBlock(), NewToolUseBlock(), ParseBlock() (+7 more)
...
### Community 72 - "makeStore"
Cohesion: 0.08
Nodes (14): createSocket(), freshSocket(), mocks, renderChatHook(), makeStore(), connectionSlice, ConnectionState, initialState (+6 more)
...
Cohesion: 0.09
Nodes (34): TreeNode, AppHeader(), ChatPanel(), NotesView(), mocks, NotificationPanel(), NOTIFICATION_ICONS, NOTIFICATION_PALETTE (+26 more)
...
Cohesion: 0.11
Nodes (39): TestEventShapeUnchanged(), TestEventTypeValues(), TestWriterFuncAdapter(), testing.T, Repo, openTestRepo(), TestFoldersParsing(), TestModelSettingRoundTrip() (+31 more)

### Community 82 - "renderWithStore"
Cohesion: 0.07
Nodes (31): mocks, mocks, renderPanel(), mocks, renderBlock(), conversations, mocks, renderDashboard() (+23 more)

### Community 83 - "react"
Cohesion: 0.12
Nodes (17): react, api, cache, CodeBlock(), highlight(), Composer(), CopyButton(), renderCopy() (+9 more)

### Community 86 - "file.go"
Cohesion: 0.18
Nodes (11): cleanRel(), NewList(), NewReadFile(), stringArg(), stringArgDefault(), truncationMarker(), TestStringArg(), TestToolNamesAreStable() (+3 more)

### Community 91 - "Accumulate"
Cohesion: 0.23
Nodes (11): Accumulate(), Message, Accumulate(), Request, Stream, Usage, Provider, Response (+3 more)

### Community 92 - "NewBuilder"
Cohesion: 0.24
Nodes (9): Block, Message, NewBuilder(), TestBuilderAccumulatesText(), TestBuilderAccumulatesThinking(), TestBuilderAccumulatesToolInput(), TestBuilderInvalidToolInput(), TestBuilderSeparatesInterleavedBlocks() (+1 more)

### Community 95 - "OpenRepo"
Cohesion: 0.36
...
### Community 97 - "api/models.go"
Cohesion: 0.46
Nodes (7): modelInput, createModel(), deleteModel(), echo.Context, models(), modelStoreError(), updateModel()

### Community 98 - "Scaffold"
Cohesion: 0.13
Nodes (17): healthyThothDir(), TestDoctorEndpointHealthy(), TestNoteEndpoint(), TestNoteEndpointMissingNote(), TestNoteEndpointRequiresPath(), TestNoteEndpointServesAttachmentsAsRawBytes(), TestSearchEndpoint(), TestSearchEndpointDefaultsBadLimit() (+9 more)

### Community 102 - "wiki.go"
Cohesion: 0.20
Nodes (13): checkMalformed(), countNotes(), TestCheckMalformed(), Index, Wiki, Hidden(), Indexable(), IsMarkdownPath() (+5 more)

### Community 103 - "doctor/doctor.go"
Cohesion: 0.30
Nodes (17): checkAPI(), checkClaude(), checkDatabase(), checkIndex(), checkSettings(), checkWebsocket(), checkWiki(), defaultAddr() (+9 more)
...
### Community 105 - "Deps"
Cohesion: 0.20
Nodes (13): Deps, github.com/go-warehouse/events.Bus, createConversation(), deleteConversation(), getConversation(), echo.Context, listConversations(), doctorHandler() (+5 more)

### Community 106 - "index.ts"
Cohesion: 0.08
Nodes (46): GitHubIdentity, GitHubRepo, GitTab(), toolLabel(), useChat(), AppDispatch, AppStore, RootState (+38 more)

### Community 107 - "file_test.go"
Cohesion: 0.26
Nodes (14): NewOSFS(), NewWriteFile(), newTestFS(), TestListTool(), TestNewOSFSValidation(), TestOSFSRejectsTraversal(), TestOSFSSymlinkEscape(), TestOSFSSymlinkInsideRoot() (+6 more)

### Community 109 - "LLMModel"
Cohesion: 0.27
Nodes (6): modelGroup, groupModels(), LLMModel, Store, isUniqueViolation(), rowsAffectedOrNotFound()
...
Cohesion: 0.15
Nodes (16): SearchResult, SearchView, SearchPanel(), mocks, renderSearchHook(), useSearch(), initialState, searchNotes (+8 more)
...
### Community 119 - "New"
Cohesion: 0.29
Nodes (9): IsImagePath(), New(), TestIndexable(), TestIsImagePath(), TestWikiNotExists(), TestWikiReadAndTree(), TestWikiReadMissingNote(), TestWikiTreeErrorOnMissingRoot() (+1 more)

### Community 120 - "gitSetup"
Cohesion: 0.54
Nodes (7): gitCmd(), gitCommitAll(), gitFailure(), gitPush(), gitSetRemote(), gitSetup(), echo.Context

### Community 122 - "startupBanner"
Cohesion: 0.36
...
### Community 129 - "internalError"
Cohesion: 0.31
Nodes (9): settingsDTO, echo.Context, internalError(), note(), search(), tree(), getSettings(), echo.Context (+1 more)

### Community 130 - "OSFS"
Cohesion: 0.27
Nodes (3): io/fs.DirEntry, io/fs.FileMode, OSFS

### Community 131 - "Service"
Cohesion: 0.50
Nodes (3): Client, Service, Repo

### Community 132 - "openTest"
Cohesion: 0.29
...
### Community 133 - ".runChecks"
Cohesion: 0.33
Nodes (6): doctorRunner, failed(), fileExists(), newDoctorCmd(), resolveThothDir(), runDoctor()

### Community 134 - "Client"
Cohesion: 0.29
Nodes (6): getResult, Profile, Repository, net/http.Client, Client, primaryEmail()

### Community 135 - "Sidebar.test.tsx"
Cohesion: 0.20
Nodes (6): conversations, mocks, older, renderSidebar(), today, yesterday

### Community 136 - "ModelOptions"
Cohesion: 0.36
Nodes (6): Option, ModelOptions(), TestModelOptionsParse(), TestModelOptionsSplitShape(), ensureModels(), TestEnsureModelsSeedsFirstBoot()

### Community 137 - "onSettingsSaved"
Cohesion: 0.36
...
### Community 139 - "ScaffoldWithOptions"
Cohesion: 0.83
Nodes (3): gitInit(), ScaffoldWithOptions(), ScaffoldOptions

## Knowledge Gaps
- **464 isolated node(s):** `ALLOWED_KINDS`, `config`, `@playwright/mcp`, `@ant-design/cli`, `Block` (+459 more)
...
- **Why does `Deps` connect `Deps` to `testDeps`, `github.go`, `api/models.go`, `Service`, `NewPersistent`, `internalError`, `runServe`, `wiki.go`, `New`, `Hub`, `context.Context`, `Repo`, `PersistentClient`, `Index`, `gitSetup`, `health.go`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `testDeps()` connect `testDeps` to `TestGitSetupReportsSanitizedFailure`, `newLoggingServer`, `New`, `Scaffold`, `New`, `Open`, `Deps`, `testing.T`, `New`, `Index`, `api/models_test.go`, `OpenRepo`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `newServer()` connect `Deps` to `testDeps`, `github.go`, `New`, `api/models.go`, `internalError`, `newTestEcho`, `requestLog`, `Hub`, `gitSetup`, `health.go`?**
