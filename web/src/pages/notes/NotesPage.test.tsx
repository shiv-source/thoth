...
function renderNotes(openPath: string | null = null) {
    ...
    const utils = renderWithStore(<NotesPage openPath={openPath} onOpenNote={onOpenNote} onOpenSettings={vi.fn()} />)
...
describe('NotesPage', () => {
    ...
    it('opens the selected note inline and closes back to the empty state', async () => {
        ...
        function Wrapper() {
            ...
            return <NotesPage openPath={open} onOpenNote={setOpen} onOpenSettings={vi.fn()} />
        }
