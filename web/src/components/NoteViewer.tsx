        ...
        <aside className="flex min-h-0 min-w-0 flex-1 flex-col bg-surface">
            ...
            <footer className="flex shrink-0 items-center justify-end border-t border-line px-5 py-3">
                <CopyButton
                    ...
                    className={`rounded-lg border border-line px-3 py-1.5 text-xs font-medium text-ink transition hover:bg-raised disabled:cursor-not-allowed disabled:opacity-40 ${content ? '' : 'pointer-events-none'}`}
                />
            </footer>
        </aside>
    )
