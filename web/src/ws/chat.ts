...
export type ServerMessage =
    | { type: ServerEvent.AssistantStart }
    | { type: ServerEvent.AssistantThinking; text: string }
    | { type: ServerEvent.AssistantDelta; text: string }
    | { type: ServerEvent.ToolActivity; tool: string; detail: string }
    | { type: ServerEvent.TurnDone; conversation_id?: string; usage?: TokenUsage }
    | { type: ServerEvent.WikiChanged; changes?: WikiChange[] }
    | { type: ServerEvent.Error; message: string }
